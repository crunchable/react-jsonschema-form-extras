...
function CollapseMenu(props) {
  ...
  return _react2.default.createElement(
    ...
    addTo && _react2.default.createElement(
      "a",
      { onClick: onAdd },
      _react2.default.createElement("i", { className: add })
    ),
    _react2.default.createElement(
      "a",
      { onClick: onChange },
      _react2.default.createElement("i", { className: collapsed ? disabled : enabled })
    ),
  ...
  function CollapsibleField(props) {
    ...
    _this3.handleAdd = function () {
      ...
      _this3.forceUpdate(function () {
        ...
        var fieldSchema = addTo === "self" ? schema.items : schema.properties[addTo].items;
    ...
    var _props$uiSchema$colla9 = props.uiSchema.collapse;
    _props$uiSchema$colla9 = _props$uiSchema$colla9 === undefined ? {} : _props$uiSchema$colla9;
    var _props$uiSchema$colla10 = _props$uiSchema$colla9.collapsed,
        collapsed = _props$uiSchema$colla10 === undefined ? true : _props$uiSchema$colla10;
